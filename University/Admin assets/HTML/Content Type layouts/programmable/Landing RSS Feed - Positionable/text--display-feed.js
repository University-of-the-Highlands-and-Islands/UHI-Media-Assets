...
<t4 type="content" name="Link below feed (internal)" output="selective-output" modifiers="nav_sections" process-format="true" format=" var belowFeed='<li class=&quot;newsevents&quot;><a href=&quot;<t4 type=&quot;content&quot; name=&quot;Link below feed (internal)&quot; output=&quot;linkurl&quot; modifiers=&quot;nav_sections&quot; />&quot;><t4 type=&quot;content&quot; name=&quot;Link below feed text&quot; output=&quot;normal&quot; modifiers=&quot;striptags,htmlentities&quot; /></a></li>'; " />
    <t4 type="content" name="Link below feed (external)" output="selective-output" process-format="true"  format=" var belowFeed='<li class=&quot;newsevents&quot;><a href=&quot;<t4 type=&quot;content&quot; name=&quot;Link below feed (external)&quot; output=&quot;normal&quot; modifiers=&quot;&quot; />&quot;> <t4 type=&quot;content&quot; name=&quot;Link below feed text&quot; output=&quot;normal&quot; modifiers=&quot;striptags,htmlentities&quot; /> </a></li>';" />
...
function displayFeed(){
    ...
    for (i = 0; i < count; ++i)
    {
        ...
        $('#rssFeed').append($('<li class="newsevents"/>').html('<a href="' + feeds[i].link + '">' + feeds[i].title + '</a><br/>' + folder + '<span class="labelfield">' + fDate.getDate().padLeft() + '/' + (fDate.getMonth()+1).padLeft() +'/' + fDate.getFullYear() +'</span>'));
    }
