...
<t4 type="content" name="Link below feed (internal)" output="selective-output" modifiers="nav_sections" process-format="true" format=" var belowFeed='<li class=&quot;content-type--landing-rss-feed__line&quot;><a href=&quot;<t4 type=&quot;content&quot; name=&quot;Link below feed (internal)&quot; output=&quot;linkurl&quot; modifiers=&quot;nav_sections&quot; />&quot;><t4 type=&quot;content&quot; name=&quot;Link below feed text&quot; output=&quot;normal&quot; modifiers=&quot;striptags,htmlentities&quot; /></a></li>'; " />
    <t4 type="content" name="Link below feed (external)" output="selective-output" process-format="true"  format=" var belowFeed='<li class=&quot;content-type--landing-rss-feed__line&quot;><a href=&quot;<t4 type=&quot;content&quot; name=&quot;Link below feed (external)&quot; output=&quot;normal&quot; modifiers=&quot;&quot; />&quot;> <t4 type=&quot;content&quot; name=&quot;Link below feed text&quot; output=&quot;normal&quot; modifiers=&quot;striptags,htmlentities&quot; /> </a></li>';" />

var maxLength = <t4 type="content" name="Number of items to display" output="normal" /> || 5 || undefined;
...
function displayFeed(){
    ...
    for (i = 0; i < count; ++i)
    {
        ...
        var folder = ((feeds[i].feedLink == "" || feeds[i].feedName == "") ? "" : "<span class='content-type--landing-rss-feed__labelfield'><a href='" + feeds[i].feedLink + "'>" + feeds[i].feedName + "</a> </span>");
        $('#rssFeed').append($('<li class="content-type--landing-rss-feed__line"/>').html('<a href="' + feeds[i].link + '">' + feeds[i].title + '</a><br/>' + folder + '<span class="content-type--landing-rss-feed__labelfield">' + fDate.getDate().padLeft() + '/' + (fDate.getMonth()+1).padLeft() +'/' + fDate.getFullYear() +'</span>'));
    }
