try {
  ...
  var layout = processTags('<t4 type="content" name="Location of title" output="normal" display_field="value" />');
  var format = null ;
  var formatString = "";

  /* if 1-2-1 */
  if (layout == 'top') {
    /* Get the Top formatter object */
    formatter = 'text/layout-top'; //bring back an object of this template
    document.write(getLayout(formatter));
  }
  if (layout == 'bottom') {
    /* Get the Bottom formatter object */
    formatter = 'text/layout-bottom'; //bring back an object of this template
    document.write(getLayout(formatter));
  }
  if (layout == 'none') {
    /* Get the None formatter object */
    formatter = 'text/layout-none'; //bring back an object of this template
    document.write(getLayout(formatter));
  }
