...
$queryHandler->setDontTokenize(array('course-code','course-location', $coursesubjectsearch, 'course-study-mode'));
$queryHandler->stemQuery(array('keyword'));
$queryHandler->setDontRemoveStopwords(array($coursesubjectsearch));
...
if(false) {   // get rid of proximity and frequency stuff
    ...
    <ul class="accordion" id="coursefilter">
      <?php
                    // Output the current 'keyword' query as hidden input so it's preserved when updating results
                                ...
                                $formatQueryAsHiddenInput->setMember('excludedQueries', array('course-level-search', $coursesubjectsearch, 'course-study-mode', 'course-location'));
